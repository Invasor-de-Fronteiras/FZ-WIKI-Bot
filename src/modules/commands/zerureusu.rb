module Bot::DiscordCommands
    ...
    **Weak Spots:** ```
    ...
    \n  ------------ ----- ----- ------ ------ ------- ----- ----- ----- -----
    \n   Head          30    50     20      0      20     0    40    10   100
    \n   Neck          25    30     25      0      10     0     0    25     0
    \n   Back          20    25     20      0      15     0     0    25     0
    \n   Belly         30    30     25      0      10     0     0    15     0
    \n   Tail          50    30     30      0      20     0    40     5     0
    ...
    \n   Back          20    25     20      0      15     0     0    25     0
    \n   Belly         30    30     25      0      10     0     0    15     0
    \n   Tail          15    30     30      0      20     0    10     5     0
    \n   Wings         25    25     50      0      20     0    40     5     0
    \n   Legs          15    30     25      0      10     0     5    15     0
    ```"
    msg.respond "```
    \n                              Adapted to Imp																
    \n   Hitzone      Cut   Imp   Shot   Fire   Water   Thu   Dra   Ice   K.O 
    \n  ------------ ----- ----- ------ ------ ------- ----- ----- ----- -----
    \n   Head          30    15     20      0      20     0    10    10   100  
    \n   Neck          25    30     25      0      10     0     0    25     0  
    \n   Back          20    25     20      0      15     0     0    25     0  
    \n   Belly         30    30     25      0      10     0     0    15     0  
    \n   Tail          50    30     30      0      20     0    40     5     0  
    ...
    **Weak Spots:** ```
    ...
    \n   Hitzone      Cut   Imp   Shot   Fire   Water   Thu   Dra   Ice   K.O 
    \n  ------------ ----- ----- ------ ------ ------- ----- ----- ----- -----
    \n   Head          10    10     10      0       0     0     0     0   100  
    \n   Neck          10    10     10      0       0     0     0     0     0  
    \n   Back          20    25     20      0      15     0     0    25     0  
    \n   Belly         30    30     25      0      10     0     0    15     0  
    \n   Tail          50    30     30      0      20     0    40     5     0  
    \n   Wings         25    25     50      0      20     0    40     5     0  
