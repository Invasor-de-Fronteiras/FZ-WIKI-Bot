module Bot::DiscordCommands
    ...
    **Weak Spots:** ```
    ...
    \n   Body          120  135     50     10       5    10     0    15     0
    \n   Tail          210  180     80     15       5    10     0    20     0
    ```"
    msg.respond "```
    \n                            Counter: Damage x4
    \n   Hitzone      Cut   Imp   Shot   Fire   Water   Thu   Dra   Ice   K.O 
    \n  ------------ ----- ----- ------ ------ ------- ----- ----- ----- ----- 
    \n   Head          245  250     60     10       5    10     0    15   200
    \n   Forelegs      210  210     40     10       5    10     0    15     0
    \n   Hindlegs      175  135     45     10       5    10     0    15     0
    ...
    **Weak Spots:** ```
    ...
    \n   Body         105   120     25      5       0     5     0    10     0
    \n   Tail         120    90     45     10       0     5     0    15     0
    ```"
    msg.respond "```
    \n                            Counter: Damage x4
    \n   Hitzone      Cut   Imp   Shot   Fire   Water   Thu   Dra   Ice   K.O 
    \n  ------------ ----- ----- ------ ------ ------- ----- ----- ----- ----- 
    \n   Head         160   175     30      5       0     5     0    10   200
    \n   Forelegs     125   105     20      5       0     5     0    10     0
    \n   Hindlegs      90   125     20      5       0     5     0    10     0
    ...
    **Weak Spots:** ```
    ...
    \n   Body          90   105     25     10       5    10     0    20     0
    \n   Tail         105    90     40     15       5    10     0    25     0
    ```"
    msg.respond "```
    \n                            Counter: Damage x4
    \n   Hitzone      Cut   Imp   Shot   Fire   Water   Thu   Dra   Ice   K.O 
    \n  ------------ ----- ----- ------ ------ ------- ----- ----- ----- ----- 
    \n   Head         140   140     30     10       5    10     0    20   200
    \n   Forelegs     105   105     20     10       5    10     0    20     0
    \n   Hindlegs     100    70     20     10       5    10     0    20     0
