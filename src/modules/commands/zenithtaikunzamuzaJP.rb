module Bot::DiscordCommands
    ...
    **別名:** M多殻蟹
    **ランク:** 辿異
    **弱点属性:**  氷 <:zice:883119912283938816> と   火 <:zfire:883120156916744312> (1st Form),   水 <:zwater:883120128017965066> と  氷 <:zice:883119912283938816> (2nd Form)
    **状態異常:** 雷属性やられ【特大】 <:zthunder:883120020312440852>
    **属性:**   雷 <:zthunder:883120020312440852> (Second Form)
    **弱点部位:** ```
    \n                                  肉質
